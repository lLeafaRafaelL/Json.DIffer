...
{
    [DefaultRoute("diff/{externalId}/left")]
    public class UploadLeftFileController : BaseController
    {
        public UploadLeftFileController(IMediator mediator) : base(mediator)
        {
        }
        ...
        CancellationToken cancellationToken)
        {
            var request = new UploadFileToCompareRequestDto
            {
                ...
                Side = Json.Differ.Domain.Files.Enums.FileSide.LEFT
            };
